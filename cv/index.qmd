...
<a class="btn btn-primary" href="https://github.com/filippigianluca" role="button" target="_blank" style="padding: 15px 30px;">View the tutorial for this template (+ download link)</a>
</div>
```
